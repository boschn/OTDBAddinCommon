...
Public Class UIControlDataGridView
    ...
    Class TagColumnData
        ...
        Friend ObjectEntry As iormObjectEntry
    End Class
    ''' <summary>
    ''' inner variables
    ''' </summary>
...
#End Region
    ...
    Private Sub DynamicInitialize()
        ...
        If _queriedEnumeration IsNot Nothing Then
            ...
            Dim anEntriesList As New List(Of iormObjectEntry)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function GetObjectEntry(entryname As String) As iormObjectEntry
        If _modeltable IsNot Nothing Then
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function CreateGridViewColumn(entrydefinition As iormObjectEntry) As GridViewColumn
    ...
    Public Sub UIControlDataGridView_OnCellValidating(sender As Object, e As CellValidatingEventArgs) Handles RadGridView.CellValidating
        If e.ColumnIndex > 0 Then
            If (e.OldValue IsNot Nothing AndAlso e.Value IsNot Nothing AndAlso Not e.Value.Equals(e.OldValue)) _
                ...
                Dim anObjectEntry As iormObjectEntry = Me.GetObjectEntry(entryname:=e.Column.FieldName)
